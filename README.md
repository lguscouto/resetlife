...
- versão atual: `0.20.0` (`versionCode = 34`);
...
- [Notas de release 0.9.1](docs/releases/0.9.1.md)
- [Notas de release 0.10.0](docs/releases/0.10.0.md)
- [Roadmap de melhorias de UI 0.11 → 0.20](docs/releases/0.20.0.md)
